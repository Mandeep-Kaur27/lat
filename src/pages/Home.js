    ...
    <div className="home">
      <footer className="footer-wrapper">
        <div className="footer">
          ...
          <div className="comunity">
            ...
            <div className="social-media1">Comunity</div>
          </div>
          <div className="about">
          ...
          <div className="nft">
            <div className="nft-18">
              ...
              <div className="profile5">
                <b className="cameron-williamson6">Cameron Williamson</b>
                <img
      ...
      <section className="header" id="banner">
        ...
        <div className="buttonregular">
          <div className="explore">Wrap Your Ordinal</div>
        </div>
        ...
        <div className="vector-parent">
          ...
          <div className="cardhover-normaloff">
            <div className="card-bid-main">
              ...
              <div className="buttonregular1">
                <div className="explore1">Collect Now</div>
              </div>
            </div>
          </div>
          ...
          <img className="image-17-icon" alt="" />
        </div>
      </section>
      <nav className="navbar1">
        <div className="container2" />
        <div className="button25">
          <b className="medium1">Connect Wallet</b>
        </div>
        <div className="menu">
